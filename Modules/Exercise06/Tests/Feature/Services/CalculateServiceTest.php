...
class CalculateServiceTest extends TestCase
{
    ...
    {
        return [
            // Bill less than 2000, not watch film
            [
                [
                    'bill' => 1000,
                    'has_watch' => false,
            ...
            // Bill less than 2000, watch film
            [
                [
                    'bill' => 1000,
                    'has_watch' => true,
            ...
            // Bill equal 5000, not watch film
            [
                [
                    'bill' => 5000,
                    'has_watch' => false,
            ...
            // Bill equal 2000, not watch film
            [
                [
                    'bill' => 2000,
                    'has_watch' => false,
            ...
            // Bill greater than 2000, watch film
            [
                [
                    'bill' => 3000,
                    'has_watch' => true,
            ...
            // Bill greater than 5000, watch film
            [
                [
                    'bill' => 6000,
                    'has_watch' => true,
